...
<section class="featured-posts">
	...
	<?php
// $usr_img="SELECT image_name FROM image WHERE id = 1";
// $userimage = mysqli_query($conn, $usr_img);
// while ($featt = mysqli_fetch_array($userimage)){
			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="card-block">
						...
						<h4 class="card-text"><?= $feat['content']?></h4>
						<div class="metafooter">
							<div class="wrapfooter">
								<span class="meta-footer-thumb">
								<a href="author.html"><img class="author-thumb" src="http://localhost/blogsnepal/assets/Profile_image/<?=$rowimage['image_name'];?>" alt="<?=$feat['name']?>"></a>
								</span>
								<span class="author-meta">
								<span class="post-name"><a href="author.html"><?= $feat['name']?></a></span><br/>
