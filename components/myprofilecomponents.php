<div class="authorpostbox">
					<div class="card">
						...
						<div class="card-block">
							<h2 class="card-title"><a href="post.html"><?php echo $_SESSION['user_title']; ?></a></h2>
							...
							<div class="metafooter">
								<div class="wrapfooter">
									<span class="meta-footer-thumb">
										<a href="myprofile.php"><img class="author-thumb"
												src="http://localhost/blogsnepal<?php echo($image['image_name'])?>";
												alt="<?php echo $_SESSION['user_name'] ?>"></a>
									</span>
									<span class="author-meta">
										<span class="post-name"><a href="myprofile.php"><?php echo $_SESSION['user_name'] ?></a></span><br />
										<span class="post-date"><?php echo date('F jS, Y', strtotime($_SESSION['date']))?></span><span class="dot"></span><span
				...
				<div class="authorpostbox">
					<div class="card">
						...
						<div class="card-block">
							<h2 class="card-title"><a href="post.html">10 Things you should learn before visiting</a>
							</h2>
							<h4 class="card-text">This is a longer card with supporting text below as a natural lead-in
								to additional content. This content is a little bit longer.</h4>
							<div class="metafooter">
